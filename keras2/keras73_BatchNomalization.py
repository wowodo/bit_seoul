...
model = Sequential()
model.add(Conv2D(10, (2,2), padding='same', input_shape=(28,28,1)))
model.add(BatchNormalization()) #dropout대신에 들어가는 경우가 많다
model.add(Activation('relu'))

model.add(Conv2D(30, (2,2), kernel_initializer='he_normal'))
model.add(BatchNormalization())
model.add(Activation('relu'))

model.add(Conv2D(40, (3,3)))
model.add(Conv2D(20,(2,2),kernel_regularizer=l1(l1=0.01)))
