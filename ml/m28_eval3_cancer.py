...
#3. 훈련
model.fit(x_train, y_train, verbose=True, eval_metric='logloss',    #메트릭스는 평가라 영향을 주지 않는다 rmse mse 에 루트를 씌운것
                            eval_set=[(x_train, y_train),(x_test, y_test)]  #훈련셋과 테스트 벌보스 둘다 볼수 있다 

)
# eval_metric의 대표 파람 =  rmse, mae, logloss, error, auc
#rmse, mae   회기에 같이 넣을 수 있지 않을까?
#logloss, error 
...
'''
[1199]  validation_0-logloss:0.00852    validation_1-logloss:0.12313
r2 :  0.956140350877193
