...
# import joblib
# joblib.dump(model, "./save/xgb_save/cencer.joblib.dat")
model.save_model("./save/xgb_save/cencer.xgb.model")
print("저장됫다")

# model2 = pickle.load(open("./save/xgb_save/cencer.pickle.dat", "rb"))
# model2 = joblib.load("./save/xgb_save/cencer.joblib.dat")
model2 = XGBClassifier() # 모델2는 한번더 xgb 인식해줘야 한다
model2.load_model("./save/xgb_save/cencer.xgb.model")
print("불러왔다")
