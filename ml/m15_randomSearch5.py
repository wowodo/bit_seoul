...
model = SVC()
model = RandomizedSearchCV(RandomForestClassifier(), parameters, verbose=2,  cv=kfold)
...
최적의 매개변수 :  RandomForestClassifier(max_depth=10, min_samples_leaf=7, n_estimators=200,
                       n_jobs=-1)
최종 정답률 :  1.0
